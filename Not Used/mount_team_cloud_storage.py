...
# MAGIC `databricks secrets put-acl --scope <name-from-above> --principal w261-su21-team<your-team-number> --permission READ`
# MAGIC 
...
df_weather.write.parquet(f"{blob_url}/weather_data_1d_spencer")
